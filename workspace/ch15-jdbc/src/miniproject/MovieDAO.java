...
public class MovieDAO {
	...
	// 예매 내역 확인하기
	public void selectListReservation() { // 전체 예매 내역
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
		...
		try {
			...
			rs = pstmt.executeQuery();
			System.out.println("=========================================================================");
			System.out.println("예매 번호\t회원 번호\t영화 번호\t영화 제목\t\t상영 날짜\t\t상영 시간\t예매 좌석 수");
			System.out.println("=========================================================================");
			while(rs.next()) {
				...
				System.out.print(rs.getString("mo_date")+"\t");
				System.out.print(rs.getString("mo_time").substring(0,5)+"\t"); // 초 단위 생략
	...
	public void selectListReservation(int me_num) { // 내 예매 내역
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
		...
		try {
			...
			rs = pstmt.executeQuery();
			System.out.println("=================================================================");
			System.out.println("예매 번호\t영화 번호\t영화 제목\t\t상영 날짜\t\t상영 시간\t예매 좌석 수");
			System.out.println("=================================================================");
			while(rs.next()) {
				System.out.print(rs.getInt("re_num")+"\t");
				System.out.print(rs.getInt("mo_num")+"\t");
