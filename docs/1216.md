...
<body>
	<div id="wrap">
		...
		<header>
			<!-- 데스크탑 로고, 메뉴 -->
			<div id="page-top">
				<h1><a href="https://ezstata.weebly.com/">Sublime with Stata</a></h1>
				<nav>
					<ul>
		...
		<section id="contents">
			...
			<ul>
				...
				<li><b><a href="multipleauto.png">자동 완성 지원</a>
					<ul>
		...
		<footer id="page-footer">
			<p>&copy; Sublime with Stata</p>
			<nav>
				<ul>
					<li><a href="home.html">하단 메뉴1</a></li>
					<li><a href="contact.html">하단 메뉴2</a></li>
					<li><a href="address.html">하단 메뉴3</a></li>
					<li><a href="board.html">하단 메뉴4</a></li>
				</ul>
			</nav>
		</footer>
	</div>
...
#mobile-page-top ul li {
	display: block;
	padding: 15px 0;
}
#mobile-page-top ul li a:hover {
	color: #9789e8;
	transition: color 0.5s ease;
}
